...
$req = "SELECT id_Video , nom_Video, saison_Video, episode_Video,duree_Video,url_Video,synopsis_Video FROM video WHERE sup_Video = 0 and saison_Video = 3";
...
while($obj = mysqli_fetch_object($res)) {
    ...
    array_push($arraySaison3,$obj);
}

# JSON-encode and return the response
echo json_encode($arraySaison3);  
